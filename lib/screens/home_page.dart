...
class _HomePageState extends State<HomePage> {
  ...
  // Añadimos la categoría 'All Doctors'
  List<Map<String, dynamic>> medCat = [
    {
      "icon": FontAwesomeIcons.userDoctor,
      "category": "All Doctors", // Nueva categoría
    },
    {
      "icon": FontAwesomeIcons.userDoctor,
      "category": "General",
  ...
  Widget build(BuildContext context) {
    ...
    List<dynamic> filteredDoctors = selectedCategory == "All Doctors"
        ? (user['doctor'] ?? []) // Si 'doctor' es null, usar lista vacía
        : selectedCategory.isEmpty
            ? (user['doctor'] ??
                []) // Si no hay categoría seleccionada, usar lista vacía
            : (user['doctor'] ?? [])
                        ...
                        child: ListView(
                          ...
                          children:
                            ...
                            return GestureDetector(
                              onTap: () {
                                setState(() {
                                  selectedCategory = medCat[index][
                                      'category']; // Actualizar categoría seleccionada
                                });
                              },
                              child: Card(
                                ...
                                color: selectedCategory ==
                                    ...
                                    : Config.primaryColor, // Color inactivo
                                child: Padding(
                                  padding: const EdgeInsets.symmetric(
                      ...
                      Column(
                        children:
                          ...
                          return DoctorCard(
                            ...
                            isFav: favList
                                    .contains(filteredDoctors[index]['doc_id'])
                                ? true
                                : false,
                          );
                        }),
